...
class VplsTopo(Topo):
    ...
    def __init__(self):
        ...
        h3 = self.addHost('h3', cls=VLANHost, vlan=300, mac='00:00:00:00:00:03', ip='10.0.0.3/24')
        h4 = self.addHost('h4', cls=VLANHost, vlan=400, mac='00:00:00:00:00:04', ip='192.168.1.4/24')
